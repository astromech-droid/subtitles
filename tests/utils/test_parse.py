...
def test_remove_linenumbers():
    test_input_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/remove_linenumbers_before.vtt"
    )
    test_output_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/remove_linenumbers_after.vtt"
    )
...
def test_remove_headers():
    test_input_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/remove_headers_before.vtt"
    )
    test_output_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/remove_headers_after.vtt"
    )
...
def test_remove_blanklines():
    test_input_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/remove_blanklines_before.vtt"
    )
    test_output_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/remove_blanklines_after.vtt"
    )
...
def test_extruct_starttime():
    test_input_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/extruct_starttime_before.vtt"
    )
    test_output_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/extruct_starttime_after.vtt"
    )
...
def test_put_starttime_on_alllines():
    test_input_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/put_starttime_on_alllines_before.txt"
    )
    test_output_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/put_starttime_on_alllines_after.txt"
    )
...
def test_merge_multilines():
    test_input_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/merge_multilines_before.txt"
    )
    test_output_file = os.path.join(
        s.TEST_DATA_DIR, "utils/parse/merge_multilines_after.txt"
    )
